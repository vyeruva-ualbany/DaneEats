...
<center>
 <table id="t01" >
        ...
        <tr>
            <td><p><%=request.getParameter("id")%></p></td>
            <td><p><%=request.getParameter("source")%></p></td>
            <td><p><%=request.getParameter("destination")%></p></td>
            <td><p><%=request.getParameter("status")%></p></td>
            <td><p><%=request.getParameter("amount")%></p></td>
            <td>
            ...
            <label for="reasons">Choose your reason:</label>
