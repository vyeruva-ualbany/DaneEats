...
(function ($) {
  ...
  var ProductManager = (function(){
    ...
    */
    ...
    var addProduct = function(id, name, summary, price, quantity, source, destination) {
      var products = getAllProducts();
      products.push({
        id: id,
        name: name,
    ...
    */
    ...
    var setProduct = function(id, name, summary, price, quantity, source, destination) {
      ...
      if(!updatePoduct(id)){
        addProduct(id, name, summary, price, quantity, source, destination);
      }
    }
  ...
  var MyCart = function (target, userOptions) {
    ...
    */
    $target.click(function(){
      ...
      ProductManager.setProduct(id, name, summary, price, quantity, source, destination);
      $cartBadge.text(ProductManager.getTotalQuantityOfProduct());
    });
